...
# Asks the user to specify the path to the folder containing the .txt files to be merged
folder = input('Please specify the path of the folder containing the .txt files to be merged: ')
...
output_file = input('Please specify the desired name of the output file (without .txt): ')
...
if nb_merged_files > 0:
    ...
    print(f'No .txt files were found in the {folder} folder.')
